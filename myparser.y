...
|		LOOP 				{
		...
		'(' DIGIT ')'		{//may implement to be able to use varibles
								...
								gc(line);	
								snprintf(line, lineSize, "\tR7 = R7 - 4; //Storing LOOP amount\n");		
								gc(line);		
		...
		decreaseScope		{
								...
								snprintf(line, lineSize, "L %d:\n", $<my_int>8);		//L N1:
								gc(line);
								snprintf(line, lineSize, "\tR7 = R7 + 4; //Generated by loop\n");		//L N1:
								gc(line);
							}
																											//L N2:
...
decreaseScope: '}' 	{ 	int vars = eliminar_scope(_scope);
						if (!_insideMeth) {
...
|*/	METH NAME '('')'':' type	{
									...
									*/
									...
									//// Guardar el contenido de los registros r0, r1, r2
									{
										...
										gc(line);
										snprintf(line, lineSize, "\tI(R7 + 0) = R6;\t//Generated by METH at line: %d\n", lines);		
										gc(line);
										snprintf(line, lineSize, "\tR6 = R7;\t//Generated by METH at line: %d\n", lines);		
										gc(line);
									}
									////					
									insertar($2, rutina, $<my_type>6, meth);
...
void methReturn(int dir){
	...
	dir = _DIR;
	snprintf(line, lineSize, "//nuevo %d\n", dir);
	gc(line);
	...
	R5 = P(R7+16);
	R7 = R7 + 20;*/
	snprintf(line, lineSize, "\tR7 = R6;\t// Generated by methReturn (no params) at %d\n", lines);
	gc(line);
	snprintf(line, lineSize, "\tR6 = P(R7);\t// Generated by methReturn (no params) at %d\n", lines);
	gc(line);
	snprintf(line, lineSize, "\tR5 = P(R7 + 16);\t// Generated by methReturn (no params) at %d\n", lines);
	gc(line);
	snprintf(line, lineSize, "\tR7 = R7 + 20;\t// Generated by methReturn (no params) at %d\n", lines);
	gc(line);
...
void initializeVar(struct varPack *pack){
	...
	if (var->cat == v_global){
		...
		/*snprintf(line, lineSize, "\tR7 = R7 - 4;\t\t//Initializing %d variable at line %d\n", pack->varType, lines); 
		gc(line);*/
		if (pack->varType == flotante){
...
void declareVar(char* id){
	...
	if (_scope == 0) {
		...
		gc(line);*/
		snprintf(line, lineSize, "\tR7 = R7 - 4;\t\t//Generated by declareVar at line %d\n", lines); 
		gc(line);
		printf("inserting %s in scope %d\n", id, _scope);
		unsigned int dir = ultima();
		insertar(id, v_local, _type, dir + 4); //4 -> int
...
void printStr(char* str){
	...
	//// Guardar el contenido de los registros r0, r1, r2
	{
		...
		gc(line);
		snprintf(line, lineSize, "\tI(R7 + 0) = R2;\t//Generated by print at line: %d\n", lines);	//I(R7 - 8) = R2;
		gc(line);
